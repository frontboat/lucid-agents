...
This is a minimal Bun HTTP agent built with `@lucid-agents/agent-kit`. It provides a simple starting point with basic entrypoint configuration and optional payment support.
...
- Import types from `@lucid-agents/agent-kit/types`
...
- [@lucid-agents/agent-kit documentation](../../../agent-kit/README.md)
